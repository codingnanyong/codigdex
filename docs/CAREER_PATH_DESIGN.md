...
현재 상세 지도 구역과 준비된 대표 기술 개체를 정확히 대조하면 다음 공백이 있다. 공유 기술 개체가 다른 지도에 존재하더라도 구역 주제와 일치하지 않으면 준비 완료로 세지 않는다.

| 1차 직업 | 현재 기술 구역 | 일치하는 대표 개체 | 추가 필요 |
|---|---:|---:|---|
| 웹 프론트엔드 개발자 | 5 | 4 | React |
| 백엔드 개발자 | 6 | 5 | 서버 프레임워크 |
| DevOps 엔지니어 | 6 | 6 | 없음 |
| 데이터 엔지니어 | 6 | 4 | 데이터 파이프라인, 워크플로 오케스트레이션 |
| 데이터 분석가 | 5 | 2 | 기초 통계, 데이터 시각화, BI 도구 |

따라서 현재 기술 구역 28개 가운데 대표 개체가 없는 구역은 7개다. 또한 전문 기술 폴더에는 대부분 챕터 표본과 Lv.3·Lv.5만 있으므로, 공통 과정과 같은 5단계 배틀을 만들 때는 각 기술의 Lv.1·Lv.2·Lv.4 개체도 별도로 제작해야 한다.
